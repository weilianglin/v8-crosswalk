  ...
  switch (instr->op()) {
    case kFloat32x4Swizzle: {
      ...
      if ((instr->hydrogen()->a1()->IsConstant() &&
        ...
        int32_t x = ToInteger32(LConstantOperand::cast(instr->a0()));
        int32_t y = ToInteger32(LConstantOperand::cast(instr->a1()));
        int32_t z = ToInteger32(LConstantOperand::cast(instr->a2()));
        int32_t w = ToInteger32(LConstantOperand::cast(instr->a3()));
  ...
  switch (instr->op()) {
    case kFloat32x4Shuffle: {
      ...
      if ((instr->hydrogen()->a2()->IsConstant() &&
        ...
        XMMRegister lhs = ToFloat32x4Register(instr->a0());
        XMMRegister rhs = ToFloat32x4Register(instr->a1());
